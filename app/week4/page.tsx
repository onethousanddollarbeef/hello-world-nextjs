        ...
        <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-16">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex gap-2">
                    <Link className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" href={toggleVoteViewHref}>
