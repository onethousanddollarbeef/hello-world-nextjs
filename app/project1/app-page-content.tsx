...
export default async function Project1AppPageContent({ searchParams }: Project1AppPageProps) {
    ...
    const toggleVoteViewHref = `/project1/app?i=${activeIndex}&showVotes=${showVotes ? "0" : "1"}`;
        ...
        <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-6 px-6 py-16">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Link className="rounded-lg border border-white bg-pink-600 px-4 py-2 text-base font-bold text-white transition active:translate-y-0.5" href="/assignments">
            ...
            {captionsError ? (
                ...
                <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                    ...
                    <div className="mt-6 flex items-center justify-between gap-2">
                        <Link className="rounded-lg border border-white bg-pink-600 px-4 py-2 text-base font-bold text-white transition active:translate-y-0.5" href={`/project1/app?i=${previousIndex}&showVotes=${showVotes ? "1" : "0"}`}>
                            Previous
                        </Link>
                        <Link className="rounded-lg border border-white bg-pink-600 px-4 py-2 text-base font-bold text-white transition active:translate-y-0.5" href={`/project1/app?i=${nextIndex}&showVotes=${showVotes ? "1" : "0"}`}>
                            Next
                        </Link>
                    </div>
                </section>
