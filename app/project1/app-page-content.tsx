    ...
    if (!hasSupabaseEnv) {
        return (
            <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-6 px-6 py-12">
                <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100">Project 1 requires Supabase setup</h1>
                <section className="rounded-2xl border border-amber-300 bg-amber-50 p-5 text-sm text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-200">
                    Set these environment variables, then restart the dev server:
