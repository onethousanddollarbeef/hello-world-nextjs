            ...
            {captionsError ? (
                ...
                <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                    ...
                    <div className="mt-6 flex items-center justify-between gap-2">
                        ...
                        <Link className="rounded-lg border border-yellow-200 bg-yellow-400 px-4 py-2 text-base font-bold text-zinc-950 transition active:translate-y-0.5" href={`/project1/app?i=${nextIndex}&showVotes=${showVotes ? "1" : "0"}`}>
                            Next
                        </Link>
                    </div>
                </section>
