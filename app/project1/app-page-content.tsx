...
export default async function Project1AppPageContent({ searchParams }: Project1AppPageProps) {
    ...
    return (
        <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-6 bg-[#f6f3e7] px-6 py-10 text-zinc-900">
            ...
            {captionsError ? (
                ...
                <section className="mx-auto w-full max-w-3xl rounded-2xl border border-zinc-200 bg-zinc-100 p-6 shadow-sm">
                    ...
                    <div className="mt-4 rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-4">
                        ...
                        <p className="text-lg font-medium text-zinc-900">{activeItem.content}</p>
