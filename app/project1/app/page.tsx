        ...
        <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-6 px-6 py-16">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    {user ? (
                        <>
                            ...
                            <form action={handleSignOut}>
                                <button className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" type="submit">
                                    Log out
                                </button>
                            </form>
                        </>
                    ...
                    <Link className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" href="/project1">
                        How it works
                    </Link>
                    <Link className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" href="/">
                        Home
                    </Link>
                    <Link className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" href="/assignments">
            ...
            {captionsError ? (
                ...
                <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900" id="meme-rater">
                    ...
                    <div className="mt-6 flex items-center gap-2">
                        <Link className="rounded-lg border border-pink-500 bg-pink-600 px-4 py-2 text-sm font-medium text-white transition active:translate-y-0.5 hover:bg-pink-500" href={`/project1/app?i=${previousIndex}`}>
                            Previous
                        </Link>
                    </div>
                </section>
