        ...
        <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-16">
            <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                    <Link className="rounded-lg border border-white bg-pink-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-pink-500 active:translate-y-0.5" href="/project1/app">
                        Let&apos;s get started
                    </Link>
                    <Link className="rounded-lg border border-white bg-pink-600 px-4 py-3 text-sm font-medium text-white transition hover:bg-pink-500" href="/assignments">
