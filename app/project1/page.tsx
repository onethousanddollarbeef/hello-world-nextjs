    ...
    return (
        <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-16">
            <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">Quick walkthrough before you jump in.</p>
                ...
                <div className="mt-6 space-y-4">
                    <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/60">
                        ...
                        <p className="mt-1 text-sm text-zinc-700 dark:text-zinc-200">Vote on each meme using the left/right action buttons.</p>
                    </div>
                    <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/60">
